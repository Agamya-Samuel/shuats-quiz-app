	...
	return (
		<Card className="border-none shadow-md">
			<CardHeader className="bg-gradient-to-r from-teal-50 to-emerald-50 rounded-t-lg">
				...
				<CardDescription>
					Track the status of your document verification process
				</CardDescription>
			</CardHeader>
			...
			<CardContent className="pt-6">
				<div className="space-y-4">
					...
					<DocumentStatusItem
						...
						icon={getStatusIcon(documentStatus.marksheet10)}
						badge={getStatusBadge(documentStatus.marksheet10)}
					/>
					...
					<div className="flex items-start gap-3">
						...
						<div>
							...
							<p className="text-sm text-blue-700 mt-1">
								Our verification team reviews all documents
								within 1-3 business days. You will be notified
								via email once the verification is complete or
				...
				<div>
					...
					{status.uploaded &&
						...
						!status.rejected && (
							<p className="text-sm text-amber-600 mt-1">
								Your document is being reviewed by our
								verification team
							</p>
						)}
					...
					{!status.uploaded && (
						<p className="text-sm text-muted-foreground mt-1">
							Please upload this document for verification
						</p>
					)}
